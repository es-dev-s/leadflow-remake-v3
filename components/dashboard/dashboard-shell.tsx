  ...
  return (
    <div className="h-dvh overflow-x-clip overflow-y-hidden bg-white text-[#212529]">
      ...
      <div className="flex h-dvh flex-col pl-14 sm:pl-[68px]">
        <Navbar />
        <main className="relative flex min-h-0 flex-1 flex-col overflow-hidden bg-[#f8f9fa] px-3 py-3 outline-none focus:outline-none sm:px-4 sm:py-3.5 lg:px-6 lg:py-4 2xl:px-8">
